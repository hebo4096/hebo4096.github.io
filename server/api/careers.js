  ...
  return [
    {
      ...
      desc: {
        en: 'Worked as Support Engineer for Azure Container Services and Entra ID. <br/><br/>Supporting Azure customer with usage and platform issues for Azure Services:<br/>&#x2022; Provide Network troubleshooting in TCP/HTTP level issues.<br />&#x2022; Provide troubleshooting for Azure Platform issues.<br/><br/> &#x2022; Container Service<br/>Azure Kubernetes Service (AKS) / Azure Red Hat OpenShift (ARO) / Azure Container Registry (ACR) / Azure Container Instances (ACI)<br/><br/> &#x2022; Authz / Authn Service<br/>Entra ID / Azure AD B2C<br/><br/> &#x2022; Other Service<br/>Azure Key Vault',
        ja_JP: 'Azure コンテナー製品 / Entra ID をはじめとするサービスのサポートエンジニアとして、サービスの利用支援やプラットフォームの問題を解析し、お客様をサポートしています: <br/>&#x2022; TCP/HTTPレベルのネットワークトラブルシューティング<br/>&#x2022; Azureプラットフォームの問題に対するトラブルシューティング<br/><br/>&#x2022; コンテナー系製品<br/>Azure Kubernetes Service (AKS)/ Azure Red Hat OpenShift (ARO) / Azure Container Registry (ACR) / Azure Container Instances (ACI) <br/><br/>&#x2022; 認証・認可系製品<br/>Entra ID / Azure AD B2C<br/><br/>&#x2022; その他製品<br/>Azure Key Vault',
      },
    },
    {
      id: 2,
